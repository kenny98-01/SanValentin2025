// Lista de canciones
const canciones = [
    "Te Regalo - (Video Oficial) - Ulices Chaidez y Sus Plebes - DEL Records 2017.mp3",
    "Río Roma - Tú me cambiaste la vida (Letra).mp3",
    "Lo que te amo  Crecer Germán letra.mp3",
    "Banda El Recodo - Te Presumo (LETRA).mp3",
    "Banda El Recodo - Me gusta todo de ti (letra).mp3",
    "(LETRA) Alta Consigna - El Poder De Tu Mirada.mp3"
];
